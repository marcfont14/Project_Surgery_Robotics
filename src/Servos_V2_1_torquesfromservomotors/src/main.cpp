...
const float Rshunt = 1.6; // shunt resistance

// Variables
float Gri_roll = 0.0, Gri_pitch = 0.0, Gri_yaw = 0.0;
float Torque_roll1 = 0.0, Torque_roll2 = 0.0, Torque_pitch = 0.0, Torque_yaw = 0.0; // s'actualitza amb getTorque()
float prevRoll1 = 0, prevRoll2 = 0, prevPitch = 0, prevYaw = 0; //dades per calcular torque en getTorque() (previous)
float sumRoll1 = 0, sumRoll2 = 0, sumPitch = 0, sumYaw = 0; //dades per calcular torque en getTorque() (sum)
...
void receiveOrientationUDP() { // recieve data from gripper
